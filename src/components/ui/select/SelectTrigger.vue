...
const props = withDefaults(
  defineProps<
    SelectTriggerProps & { class?: HTMLAttributes['class']; size?: 'sm' | 'default' | 'lg' }
  >(),
  { size: 'default' },
)
...
<template>
  ...
  >
    ...
    <SelectIcon as-child>
      <ChevronDown
        class="data-[size=sm]:size-4 data-[size=default]:size-5 data-[size=lg]:size-5 text-muted-foreground"
      />
    </SelectIcon>
  </SelectTrigger>
</template>
